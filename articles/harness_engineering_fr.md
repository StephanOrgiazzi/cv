...
Déplacer les règles d'"enforcement" hors du contexte permanent et dans les hooks est **l'un des nettoyages les plus effciaces que vous puissiez faire**. Cela permet de garder `AGENTS.md/CLAUDE.md` centré sur ce qui a réellement besoin de contexte, et de réserver la couche système à ce qui exige des **garanties absolues**.
